...
public class Controls {
    ...
    private InputListener turnkeyListener = new ActionListener() {
        @Override
        public void onAction(String name, boolean isPressed, float tpf) {
            if (isPressed) {
                ...
                if (cube.highlighted.isEmpty()){
                    ...
                    cube.rotateHighlightedPlane(direction);
                }
            }
        }
    };

    private InputListener highlightKeyListener = new ActionListener() {
        @Override
        public void onAction(String name, boolean isPressed, float tpf) {
    ...
    private InputListener leftClickListener = new ActionListener() {
    ...
    private InputListener randomizelistener = new ActionListener() {
        @Override
        public void onAction(String name, boolean isPressed, float tpf) {
            if (isPressed){
                cube.randomize(20);
